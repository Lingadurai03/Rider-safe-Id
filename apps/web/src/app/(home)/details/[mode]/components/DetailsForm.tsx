...
const DetailsForm = ({ mode }: { mode: string }) => {
    ...
    return (
        ...
        >
            ...
            {fields.map((field, index) => (
                ...
                >
                    ...
                    {fields.length > 1 && (
                        <Trash2
                            size={20}
                            className='absolute top-2 right-2 text-red-500 cursor-pointer hover:scale-125 transition-transform'
            ...
            {fields.length != 3 && (
                <div className='flex justify-start col-span-1 lg:col-span-2'>
                    <button
                        ...
                        className='bg-secondary text-xs py-2 px-4 rounded-md hover:bg-opacity-90'
            ...
            <Button
                type='submit'
                label={mode === 'edit' ? 'Update Details' : 'Add Details'}
            />
        </form>
    );
};
